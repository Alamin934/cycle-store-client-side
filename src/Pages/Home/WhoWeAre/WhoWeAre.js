    ...
    return (
        <div>
            <section className="py-5">
                <Container>
                    <h1 className="text-center mb-4 fw-bold">Who <span className="text-info">We Are?</span></h1>
                    <Row className="g-4">
                        <Col xs={12} md={6}>
                        ...
                        <Col xs={12} md={6}>
                            ...
                            <Button variant="info" className="rounded-pill px-4 py-2">Read More</Button>
                        </Col>
                    </Row>
                </Container>
            </section>
