    ...
    return (
        <div>
            <div className="p-3 p-md-5">
                <Row className="g-4 bg-info p-4 pb-5 rounded shadow-lg h-auto">
                    <Col xs={12} md={3}>
                        <div className="border-end border-dark border-2 bg-light p-4 rounded shadow">
                    ...
                    <Col xs={12} md={9}>
                        <div className="p-3 bg-light h-auto rounded shadow">
                            <Switch>
